...
function Layout({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "bg-card border-b border-border shadow-subtle sticky top-0 z-40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "🫘" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-semibold text-foreground tracking-tight", children: "Nephron Explorer" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        isExploring && onBackToMap && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            onClick: onBackToMap,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground font-mono hidden sm:block", children: "Interactive Kidney Journey" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 flex flex-col", children }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-muted/40 border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground text-center", children: [
      "© ",
...
const INITIAL_STATE = {
  ...
  visitedStages: /* @__PURE__ */ new Set(),
  isTransitioning: false
};
function useNephronGame() {
  const [state, setState] = reactExports.useState(INITIAL_STATE);
  const goToStage = reactExports.useCallback((index2) => {
    if (index2 < 0 || index2 >= NEPHRON_STAGES.length) return;
    setState((prev) => ({
      ...prev,
      currentStageIndex: index2,
      explorationPhase: "exploring",
      isTransitioning: false
    }));
  }, []);
  const startExploring = reactExports.useCallback(() => {
    setState((prev) => ({
      ...prev,
  ...
  const returnToMap = reactExports.useCallback(() => {
    setState((prev) => ({
      ...prev,
      explorationPhase: "map",
      visitedStages: /* @__PURE__ */ new Set([...prev.visitedStages, prev.currentStageIndex]),
      isTransitioning: false
    }));
  }, []);
  const goToWelcome = reactExports.useCallback(() => {
    setState(INITIAL_STATE);
  }, []);
  const completeJourney = reactExports.useCallback(() => {
    setState((prev) => ({
      ...prev,
...
const PATHWAY_D = "M 120,80 C 200,80 280,60 280,120 C 280,200 340,300 280,400 C 220,500 160,420 130,280 C 100,160 180,100 200,200 C 220,300 260,440 260,540";
...
function FiltrationAnimation() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("title", { id: "filtr-title", children: "Filtration: blood enters glomerulus, filtrate passes into tubule" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("defs", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("radialGradient", { id: "glomGrad", cx: "50%", cy: "50%", r: "50%", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: "#a070f0", stopOpacity: "0.5" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "#7040c0", stopOpacity: "0.1" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "marker",
            {
              ...
              refY: "3",
              orient: "auto",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M0,0 L6,3 L0,6 Z", fill: "#5555ee" })
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        CAPILLARY_LOOPS.map(({ key, rx, ry, rotate }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "ellipse",
          {
            cx: 100,
            cy: 80,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "8", y: "55", fontSize: "9", fill: "#e05050", fontWeight: "700", children: "Blood in" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "path",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "4", y: "115", fontSize: "9", fill: "#c03030", fontWeight: "700", children: "Blood out" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "path",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "62", y: "160", fontSize: "9", fill: "#6090e8", fontWeight: "700", children: "Filtrate →" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "100", cy: "80", r: "3", fill: "#88ccff", opacity: "0.9", children: /* @__PURE__ */ jsxRuntimeExports.jsx("animateMotion", { dur: "2s", repeatCount: "indefinite", path: "M0,0 L0,50" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "96", cy: "76", r: "2.5", fill: "#aaddff", opacity: "0.8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "animateMotion",
          {
            dur: "2.3s",
...
function ReabsorptionAnimation() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("title", { id: "reabs-title", children: "Reabsorption: molecules leave tubule and enter bloodstream capillary" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "marker",
          {
            ...
            refY: "3",
            orient: "auto",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M0,0 L6,3 L0,6 Z", fill: "#28b464" })
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "rect",
        ...
        ["mv-0", "mv-1", "mv-2", "mv-3", "mv-4", "mv-5", "mv-6"].map(
          (key, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "rect",
            {
              x: 65 + i * 10,
              y: "18",
        ...
        REABSORPTION_ROWS.map(({ key, y, dur, begin }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "100", cy: y, r: "4", fill: "#60cc88", opacity: "0.9", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "animateMotion",
            {
              dur,
              repeatCount: "indefinite",
...
function LoopAnimation() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("title", { id: "loop-title", children: "Loop of Henle: water exits descending limb, salts exit ascending limb" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "marker",
          {
            id: "arrowOrange",
            ...
            refY: "3",
            orient: "auto",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M0,0 L6,3 L0,6 Z", fill: "#e07820" })
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "path",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "20", y: "55", fontSize: "8", fill: "#4488dd", fontWeight: "700", children: "H₂O" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "20", y: "75", fontSize: "8", fill: "#4488dd", fontWeight: "700", children: "H₂O" }),
        LOOP_WATER.map(({ key, cy, dur, begin }) => /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "60", cy, r: "3", fill: "#88aaff", opacity: "0.9", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "animateMotion",
          {
            dur,
            repeatCount: "indefinite",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "148", y: "75", fontSize: "8", fill: "#e07820", fontWeight: "700", children: "Na⁺" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "148", y: "100", fontSize: "8", fill: "#e07820", fontWeight: "700", children: "Cl⁻" }),
        LOOP_SALT.map(({ key, cy, dur, begin }) => /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "140", cy, r: "3", fill: "#ffcc66", opacity: "0.9", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "animateMotion",
          {
            dur,
            repeatCount: "indefinite",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "text",
          {
            ...
            fontWeight: "700",
            fill: "#b05010",
            children: "Countercurrent Multiplier"
          }
        )
      ]
    }
...
function SecretionAnimation() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("title", { id: "secr-title", children: "Secretion: aldosterone triggers Na+ reabsorption and K+ secretion" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "marker",
          {
            id: "arrowPurple",
            ...
            refY: "3",
            orient: "auto",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M0,0 L6,3 L0,6 Z", fill: "#9e3ce6" })
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "rect",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "100", cy: "60", r: "4", fill: "#cc66ee", opacity: "0.9", children: /* @__PURE__ */ jsxRuntimeExports.jsx("animateMotion", { dur: "2s", repeatCount: "indefinite", path: "M0,0 L-50,0" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "2", y: "98", fontSize: "8", fill: "#9e3ce6", fontWeight: "700", children: "K⁺ → lumen" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "165", cy: "100", r: "4", fill: "#aa44dd", opacity: "0.9", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "animateMotion",
          {
            dur: "2s",
            repeatCount: "indefinite",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "148", y: "95", fontSize: "8", fill: "#7030b0", fontWeight: "700", children: "Na⁺" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "148", y: "106", fontSize: "8", fill: "#7030b0", fontWeight: "700", children: "↓ in" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "text",
          {
            x: "100",
            ...
            fontWeight: "700",
            fill: "#7030b0",
            children: "Hormone-Controlled Tuning"
          }
        )
      ]
    }
...
function CollectionAnimation() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("title", { id: "coll-title", children: "Collection: ADH opens aquaporins, water exits, urine concentrates" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "marker",
          {
            id: "arrowRed",
            ...
            refY: "3",
            orient: "auto",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M0,0 L6,3 L0,6 Z", fill: "#e03c32" })
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "rect",
        ...
        COLLECTION_DROPS.map(({ key, cy, dur, begin }) => /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "80", cy, r: "3.5", fill: "#88bbff", opacity: "0.85", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "animateMotion",
          {
            dur,
            repeatCount: "indefinite",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "12", y: "108", fontSize: "8", fill: "#3060e0", fontWeight: "700", children: "← H₂O reabsorbed" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "path",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "100", cy: "152", r: "5", fill: "#ff8866", opacity: "0.8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "animate",
          {
            attributeName: "r",
            values: "4;6;4",
...
function StageAnimation({ type }) {
  switch (type) {
    case "filtration":
      return /* @__PURE__ */ jsxRuntimeExports.jsx(FiltrationAnimation, {});
    case "reabsorption":
      return /* @__PURE__ */ jsxRuntimeExports.jsx(ReabsorptionAnimation, {});
    case "loop":
      return /* @__PURE__ */ jsxRuntimeExports.jsx(LoopAnimation, {});
    case "secretion":
      return /* @__PURE__ */ jsxRuntimeExports.jsx(SecretionAnimation, {});
    case "collection":
      return /* @__PURE__ */ jsxRuntimeExports.jsx(CollectionAnimation, {});
  }
}
function ReabsorptionBar({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-36 shrink-0 text-muted-foreground truncate", children: substance }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "w-8 text-right font-mono text-xs", style: { color }, children: [
      percentage,
      "%"
    ] })
  ] });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-1 font-display text-2xl font-bold text-foreground", children: stage.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-muted-foreground leading-relaxed", children: stage.shortDesc })
              ] })
            ] })
          }
        ),
                  ...
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx(StageAnimation, { type: stage.animationType })
                      }
                    )
                  }
                )
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h3",
                  {
                    className: "font-display font-semibold text-sm",
                    style: { color: colors.text },
                    children: "Substances involved"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex flex-col gap-1.5", children: stage.substances.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "li",
                  {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground leading-relaxed", children: stage.fullDesc })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-foreground leading-relaxed", children: stage.funFact })
              ] })
            ]
          }
        ),
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h3",
                {
                  ...
                  style: { color: colors.text },
                  children: "Processing rates"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-2.5", children: stage.reabsorptionData.map((d) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                ReabsorptionBar,
                {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 justify-between pt-1 pb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
...
function NephronMapSVG({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      style: { maxHeight: 560 },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("title", { id: "nephron-map-title", children: "Interactive nephron pathway map inside kidney cross-section" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("defs", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("radialGradient", { id: "kidneyGrad", cx: "45%", cy: "50%", r: "55%", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: "#f5e8d0", stopOpacity: "0.85" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "60%", stopColor: "#e8c49a", stopOpacity: "0.5" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "#c8a070", stopOpacity: "0.2" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("filter", { id: "nodeShadow", children: /* @__PURE__ */ jsxRuntimeExports.jsx("feDropShadow", { dx: "0", dy: "2", stdDeviation: "3", floodOpacity: "0.25" }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "ellipse",
          {
        ...
        NEPHRON_STAGES.map((stage, i) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "g",
            {
              ...
              style: { outline: "none" },
              children: [
                (visited || isCurrentOrNext || isDone) && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "circle",
                  {
                    r: visited || isDone ? 30 : 26,
                    fill: colors.glow,
                    opacity: isDone ? 0.5 : visited ? 0.35 : 0.55,
                    className: isCurrentOrNext && !isDone ? "stage-pulse" : void 0
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "circle",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { transform: "translate(0, 26)", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "rect",
                    {
                      x: "-38",
                ...
                (visited || isDone) && /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { transform: "translate(12, -12)", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { r: "7", fill: colors.text }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "text",
                    {
                      textAnchor: "middle",
        ...
        explorationPhase !== "done" && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "g",
          {
            transform: `translate(${NODE_POSITIONS[currentStageIndex].x - 4}, ${NODE_POSITIONS[currentStageIndex].y - 38})`,
            className: "float-droplet",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("text", { fontSize: "18", style: { userSelect: "none" }, children: "💧" })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { transform: "translate(340, 30)", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "rect",
            {
              x: "0",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "8", y: "16", fontSize: "8", fontWeight: "700", fill: "#604020", children: "MAP LEGEND" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "circle",
            {
              cx: "16",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "28", y: "34", fontSize: "7.5", fill: "#605040", children: "Unvisited stage" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "16", cy: "47", r: "7", fill: "#7857e8" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "text",
            {
              x: "16",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "28", y: "51", fontSize: "7.5", fill: "#605040", children: "Visited stage" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "circle",
            {
              cx: "16",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "28", y: "68", fontSize: "7.5", fill: "#605040", children: "💧 Your position" })
        ] })
      ]
    }
  );
...
function CompletionOverlay({ onRestart }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            "aria-hidden": "true",
            children: CONFETTI_ITEMS.map(({ key, left, top, color, animDur, animDelay }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl font-bold text-white mb-2", children: "Journey Complete!" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-6 leading-relaxed", children: "You’ve explored the full nephron — from ultrafiltration in the glomerulus all the way to concentrated urine leaving the collecting duct." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-3 flex-wrap justify-center mb-6", children: NEPHRON_STAGES.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "span",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-white mb-1", children: "🧠 Quick recap:" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Filtration → Reabsorption (bulk) → Concentration loop → Fine-tuning → Final water control. The kidney filters your entire blood volume ~60× per day!" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function StageList({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-1", children: "Or jump to any stage:" }),
    NEPHRON_STAGES.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1", children: s.name }),
          visitedStages.has(i) && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", children: "✓" })
        ]
      },
      s.id
    ))
...
function ProgressDots({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1.5", children: NEPHRON_STAGES.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: "w-2.5 h-2.5 rounded-full transition-smooth",
      style: {
        background: visitedStages.has(i) ? STAGE_COLORS[s.colorVar].text : "var(--color-muted-foreground, #888)",
        opacity: visitedStages.has(i) ? 1 : 0.3,
        transform: i === currentStageIndex && explorationPhase !== "done" ? "scale(1.5)" : "scale(1)"
      }
    },
    s.id
  )) });
}
function AdventureMapPage({ game }) {
  const {
    explorationPhase,
    currentStageIndex,
    visitedStages,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        explorationPhase === "done" && /* @__PURE__ */ jsxRuntimeExports.jsx(CompletionOverlay, { onRestart: goToWelcome }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col lg:flex-row min-h-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
            ...
            ${explorationPhase === "exploring" ? "hidden lg:flex" : "flex"}`,
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 pt-5 pb-3 flex items-center justify-between flex-shrink-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-xl font-bold text-foreground", children: "Nephron Journey" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: allVisited ? "All stages explored! 🌟" : `${visitedStages.size} of ${NEPHRON_STAGES.length} stages visited` })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    ProgressDots,
                    {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 px-4 pb-4 flex items-center justify-center overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  NephronMapSVG,
                  {
                    visitedStages,
                    currentStageIndex,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 pb-4 flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground text-center italic", children: "Click any node to explore that stage" }) })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                explorationPhase === "map" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full flex flex-col items-center justify-center px-6 py-12 fade-in", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-sm text-center", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-6xl mb-5", children: "🫘" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl font-bold text-foreground mb-3", children: "Ready to explore?" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-sm leading-relaxed mb-6", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Renal Corpuscle" }),
                    " — click a node on the map to dive into any stage of the nephron, or start from the beginning."
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                ...
                explorationPhase === "exploring" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 sm:px-6 py-6", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      type: "button",
                ...
                explorationPhase === "done" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full flex items-center justify-center p-8 fade-in", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-4xl mb-3", children: "🌟" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-lg font-bold text-foreground", children: "All stages explored!" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-2", children: "Check the completion panel" })
                ] }) })
              ]
            }
          )
...
function WelcomePage({ onEnter }) {
  const [badgeVisible, setBadgeVisible] = reactExports.useState(false);
  ...
  function handleStart() {
    setZooming(true);
    setTimeout(() => onEnter(), 1e3);
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fade-in relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-background px-4 py-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute inset-0", "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "slide-up relative z-10 mb-8 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-5xl font-bold tracking-tight text-foreground", children: "Nephron Explorer" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-lg font-body text-muted-foreground", children: "An interactive journey through the kidney’s filtration system" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "svg",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "280", cy: "242", rx: "210", ry: "175", fill: "#e8c49a" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "280", cy: "242", rx: "155", ry: "128", fill: "#d4906a" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "polygon",
                  {
                ...
                ].map(({ id, cx, cy }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "circle",
                  {
                    cx,
                    cy,
                ...
                badgeVisible && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "circle",
                  {
                    cx: "280",
                    cy: "170",
          ...
          badgeVisible && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              onClick: handleStart,
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "journey-badge__dot", "aria-hidden": "true" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "relative z-10 mt-6 text-sm font-body text-muted-foreground", children: "Click the badge on the renal pyramid to begin" })
  ] });
}
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Layout,
    {
      ...
      children: [
        game.explorationPhase === "welcome" && /* @__PURE__ */ jsxRuntimeExports.jsx(WelcomePage, { onEnter: game.startExploring }),
        (game.explorationPhase === "map" || game.explorationPhase === "exploring" || game.explorationPhase === "done") && /* @__PURE__ */ jsxRuntimeExports.jsx(AdventureMapPage, { game })
      ]
    }
  );
}
